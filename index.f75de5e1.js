...
const getSortComparator = (columnName, ascending)=>{
    ...
    switch(columnName){
        case "name":
            return (a, b)=>multiplier * a.cells[0].textContent.localeCompare(b.cells[0].textContent);
        case "position":
            return (a, b)=>multiplier * a.cells[1].textContent.localeCompare(b.cells[1].textContent);
        case "office":
            return (a, b)=>multiplier * a.cells[2].textContent.localeCompare(b.cells[2].textContent);
        case "age":
            return (a, b)=>multiplier * (parseInt(a.cells[3].textContent) - parseInt(b.cells[3].textContent));
        case "salary":
            return (a, b)=>{
                const aSalary = parseFloat(a.cells[4].textContent.replace(/[^\d.-]/g, ""));
                const bSalary = parseFloat(b.cells[4].textContent.replace(/[^\d.-]/g, ""));
